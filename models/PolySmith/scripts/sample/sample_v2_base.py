...
def parse_args():
    ...
    parser.add_argument("--checkpoint", type=Path, default=PROJ_ROOT / "checkpoints/modelv2_best.pt",
    ...
    parser.add_argument("--output-dir", type=Path, default=PROJ_ROOT / "outputs",
