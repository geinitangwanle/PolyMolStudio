...
def parse_args():
    ...
    parser.add_argument("--csv", type=Path, default=PROJ_ROOT / "data/PSMILES_Tg_only.csv") # 输入数据 CSV 文件路径
    parser.add_argument("--col-smiles", type=str, default="PSMILES") # SMILES 列名
    parser.add_argument("--col-tg", type=str, default="Tg") # Tg 列名
    parser.add_argument("--polybert-dir", type=Path, default=PROJ_ROOT / "polybert") # polyBERT 模型目录
    ...
    parser.add_argument("--output", type=Path, default=PROJ_ROOT / "checkpoints/modelv3_tg.pt") # 模型检查点保存路径
