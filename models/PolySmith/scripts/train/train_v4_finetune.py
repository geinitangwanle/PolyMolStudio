...
def parse_args(argv: Optional[Iterable[str]] = None):
    ...
    parser.add_argument("--csv", type=Path, default=PROJ_ROOT / "data/PSMILES_Tg_only.csv", help="带 Tg 的数据集 CSV 路径")
    ...
    parser.add_argument("--pretrained", type=Path, default=PROJ_ROOT / "checkpoints/pretrain_modelv4.pt", help="预训练 checkpoint 路径")
    parser.add_argument("--polybert-dir", type=str, default=str(PROJ_ROOT / "polybert"), help="polyBERT 权重路径或 HF 名称")
    parser.add_argument("--output", type=Path, default=PROJ_ROOT / "checkpoints/finetune_tg_modelv4.pt")
