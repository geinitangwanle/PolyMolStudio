...
def parse_args(argv: Optional[Iterable[str]] = None):
    ...
    parser.add_argument("--csv", type=Path, default=PROJ_ROOT / "data/PI1M_v2_psmiles.csv", help="输入 CSV 路径（需包含 PSMILES 列）")
    ...
    parser.add_argument("--output", type=Path, default=PROJ_ROOT / "checkpoints/pretrain_modelv4.pt")
