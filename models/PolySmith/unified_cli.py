...
已迁移到 PolyMolStudio 下，可直接从仓库根目录调用：
  - 训练 v4 预训练：python -m models.PolySmith.unified_cli train --version v4 --mode pretrain -- --csv models/PolySmith/data/PI1M_v2_psmiles.csv
  - 训练 v4 Tg 微调：python -m models.PolySmith.unified_cli train --version v4 --mode finetune -- --csv models/PolySmith/data/PSMILES_Tg_only.csv
  - 训练 v3 Tg：    python -m models.PolySmith.unified_cli train --version v3 -- --csv models/PolySmith/data/PSMILES_Tg_only.csv
  - 训练 v1/v2：    python -m models.PolySmith.unified_cli train --version v2
  - 采样 v4 预训练：python -m models.PolySmith.unified_cli sample --version v4 --mode uncond -- --checkpoint models/PolySmith/checkpoints/pretrain_modelv4.pt
  - 采样 v4 Tg：    python -m models.PolySmith.unified_cli sample --version v4 --mode tg -- --checkpoint models/PolySmith/checkpoints/finetune_tg_modelv4.pt
  - 采样 v3 Tg：    python -m models.PolySmith.unified_cli sample --version v3 -- --checkpoint models/PolySmith/checkpoints/modelv3_tg.pt
  - 采样 v1/v2：    python -m models.PolySmith.unified_cli sample --version v2 -- --checkpoint models/PolySmith/checkpoints/modelv2_best.pt
