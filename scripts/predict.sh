...
# 执行代码
srun python predict/predict.py --ckpt_path checkpoints/predictor.pt \
    --csv_path outputs_masked/sampled_smiles_masked.csv \
    --psmiles_col smiles \
    --save_dir data/processed/pred_graph \
    --batch_size 32 \
    --num_workers 0 \
    --device auto \
    --seed 42 \
    --out_csv outputs_masked/predicted_smiles.csv
